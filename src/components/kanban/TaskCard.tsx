  ...
  return (
    ...
    >
      ...
      <AnimatePresence initial={false}>
        {showGodMode ? (
          <motion.div
            className="mt-4 -mx-4 -mb-4 rounded-b-xl border-t border-slate-200 bg-slate-50 px-4 py-3 pb-4 text-xs text-slate-600 dark:border-slate-800 dark:bg-slate-950/60 dark:text-slate-300"
